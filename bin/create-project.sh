...
case "$1" in
    ...
    "neos")
        ...
        echo "\nNOTE: You probably want to change the WEB_DOCUMENT_ROOT env in your etc/environment.yml to '/app/Web/' and run 'docker-compose up -d app' to populate the change."
        ;;
